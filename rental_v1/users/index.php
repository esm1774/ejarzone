...
$query = "SELECT u.*, GROUP_CONCAT(p.permission_name) as permissions 
          FROM users u 
...
$query .= " GROUP BY u.user_id ORDER BY u.created_at DESC LIMIT :offset, :perPage";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                foreach ($permissions as $permission) {
                                                    if (!empty($permission)) {
                                                        echo '<span class="badge bg-info me-1">' . htmlspecialchars($permission) . '</span>';
                                                    }
                                                }
                                                ?>
                                            </td>
