                                ...
                                <tbody>
                                    <?php foreach ($units as $unit): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="<?php echo getUrl('units/view.php?id=' . $unit['unit_id']); ?>" 
                                                       class="btn btn-sm btn-info" title="عرض التفاصيل">
                                                        <i class="bi bi-eye"></i>
                                                    </a>
                                                    <a href="<?php echo getUrl('units/edit.php?id=' . $unit['unit_id']); ?>" 
                                                       class="btn btn-sm btn-warning" title="تعديل">
                                                        <i class="bi bi-pencil"></i>
                                                    </a>
                                                    <?php if ($unit['status'] !== 'مؤجرة'): ?>
                                                        <button type="button" 
                                                                class="btn btn-sm btn-danger delete-unit" 
                                                                data-id="<?php echo $unit['unit_id']; ?>"
                                                                title="حذف">
