...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // إضافة العقد الجديد
        $query = "INSERT INTO contracts (unit_id, tenant_id, start_date, end_date, rent_amount, rent_type, notes, building_id, floor) 
                  SELECT :unit_id, :tenant_id, :start_date, :end_date, :rent_amount, :rent_type, :notes, building_id, floor
                  FROM units 
                  WHERE unit_id = :unit_id";
