...
function getFullPath($path) {
    return BASE_PATH . '/rental_f/Rental/' . ltrim($path, '/');
}

// دالة للحصول على URL الكامل
function getUrl($path) {
    return BASE_URL . '/rental_f/Rental/' . ltrim($path, '/');
}

// تكوين قاعدة البيانات
define('DB_HOST', 'localhost');
define('DB_NAME', 'u402628076_rental1');
define('DB_USER', 'u402628076_esmail');
