...
define('DB_NAME', 'u402628076_rental');
define('DB_USER', 'u402628076_elbesawy');
...
function hasPermission($permissionName) {
    ...
    // إذا كان المستخدم مدير النظام، يمتلك كل الصلاحيات
    if (isset($_SESSION['role']) && $_SESSION['role'] === 'مدير النظام') {
        return true;
    }
