                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control" id="payment_type" name="payment_type" required>
                                                <option value="كاش" <?php echo ($revenue['payment_type'] == 'كاش') ? 'selected' : ''; ?>>كاش</option>
                                                <option value="تحويل" <?php echo ($revenue['payment_type'] == 'تحويل') ? 'selected' : ''; ?>>تحويل</option>
                                                <option value="شبكة" <?php echo ($revenue['payment_type'] == 'شبكة') ? 'selected' : ''; ?>>شبكة</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="received_by" name="received_by" required value="<?php echo $revenue['received_by']; ?>"> 
                                        </div>
                                    </div>
