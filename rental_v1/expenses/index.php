                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="view.php?id=<?php echo $expense['expense_id']; ?>" 
                                               class="btn btn-sm btn-info" title="عرض التفاصيل">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <a href="edit.php?id=<?php echo $expense['expense_id']; ?>" 
                                               class="btn btn-sm btn-warning" title="تعديل">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <a href="delete.php?id=<?php echo $expense['expense_id']; ?>" 
                                               class="btn btn-sm btn-danger" title="حذف">
                                                <i class="bi bi-trash"></i>
                                            </a>
                                            <a href="print_receipt.php?id=<?php echo $expense['expense_id']; ?>" 
                                            class="btn btn-link" title="طباعة">
