                    ...
                    <form id="editExpenseForm" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="payment_type" class="form-select" required>
                                <option value="كاش" <?php echo ($expense['payment_type'] == 'كاش') ? 'selected' : ''; ?>>كاش</option>
                                <option value="تحويل" <?php echo ($expense['payment_type'] == 'تحويل') ? 'selected' : ''; ?>>تحويل</option>
                                <option value="شبكة" <?php echo ($expense['payment_type'] == 'شبكة') ? 'selected' : ''; ?>>شبكة </option>
                            </select>
                        </div>
