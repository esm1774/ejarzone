...
require_once '../config/config.php'; // إضافة ملف التكوين
...
<body>
    ...
    <div class="receipt-container">
        ...
        <div class="receipt-details">
            ...
            <div class="value"><?php echo htmlspecialchars($revenue['received_by']); ?></div>
            <div class="value"></div>
            ...
            <div class="value"><?php echo htmlspecialchars($revenue['description']); ?></div>
            <div class="value"></div>
            <div class="label" style="text-align: left;">payment against :</div>

            <div class="label">طريقة الدفع:</div>
            <div class="value"><?php echo $revenue['method_name']; ?></div>
             <div class="value"></div>
