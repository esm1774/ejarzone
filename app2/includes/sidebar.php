...
$rolePermissions = [
    'مدير' => ['dashboard', 'units', 'tenants', 'contracts', 'payments', 'reports', 'expenses', 'revenues', 'users', 'settings', 'maintenance', 'roles', 'permissions'],
...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item has-submenu">
            <?php if (in_array('permissions', $allowedPages)): ?>
            <a class="nav-link" href="#">
                <i class="bi bi-cash-stack "></i>
            ...
            <ul class="submenu nav flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo getUrl('users/manage_user_permissions.php'); ?>">
                        <i class="bi bi-list-ul"></i>
                        <span>إدارة الصلاحيات</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo getUrl('users/manage_roles.php'); ?>">
                        <i class="bi bi-plus-lg"></i>
