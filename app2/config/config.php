...
function getFullPath($path) {
    return BASE_PATH . '/app2/' . ltrim($path, '/');
}

// دالة للحصول على URL الكامل
function getUrl($path) {
    return BASE_URL . '/app2/' . ltrim($path, '/');
}

// تكوين قاعدة البيانات
define('DB_HOST', 'localhost');
define('DB_NAME', 'u402628076_app2');
define('DB_USER', 'u402628076_app2');
...
// معلومات التطبيق
define('APP_NAME', 'إدارة الشقق الفندقية');
