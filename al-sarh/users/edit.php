    ...
    try {
        ...
        if ($isActive && !$currentStatus) {
            ...
            $stmt = $db->prepare("
                ...
                WHERE user_id = ?
            ");
            $stmt->execute([$fullName, $email, $role, $isActive, $hashedPassword, $forcePasswordChange, $tempPassword, $userId]);
            ...
            $emailBody = "
                ...
                <p>كلمة المرور المؤقتة الخاصة بك هي: <strong>{$tempPassword}</strong></p>
