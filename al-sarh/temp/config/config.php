...
function getFullPath($path) {
    return BASE_PATH . '/al-sarh/' . ltrim($path, '/');
}

// دالة للحصول على URL الكامل
function getUrl($path) {
    return BASE_URL . '/al-sarh/' . ltrim($path, '/');
}

// تكوين قاعدة البيانات
define('DB_HOST', 'localhost');
define('DB_NAME', 'u402628076_alsarh_db');
define('DB_USER', 'u402628076_alsarh');
...
define('SMTP_FROM_EMAIL', 'support@ejarzone.com');
