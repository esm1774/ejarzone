...
<head>
    ...
    <title>تسجيل مستخدم جديد - الصرح</title>
    ...
    <div class="register-container">
        <div class="card">
            <div class="card-header text-center">
                <h3><i class="bi bi-person-plus-fill me-2"></i>تسجيل مستخدم جديد</h3>
            </div>
            <div class="card-body">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            email.addEventListener('input', function() {
                ...
                updateFieldStatus(this, isValid, isValid ? '' : 'البريد الإلكتروني غير صالح');
                ...
                if (isValid) {
                    emailCheckTimeout = setTimeout(async () => {
                        ...
                        updateFieldStatus(this, !exists, exists ? 'البريد الإلكتروني مستخدم بالفعل' : '');
                    }, 500);
                }
            });
