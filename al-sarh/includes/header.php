                ...
                <div class="dropdown">
                    <button class="btn btn-link dropdown-toggle border-0 d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="user-avatar">
                            <?php 
                            $userName = isset($_SESSION['user_name']) && !empty($_SESSION['user_name']) ? $_SESSION['user_name'] : 'م';
                            echo mb_substr($userName, 0, 1, 'UTF-8'); 
                            ?>
                        </div>
                        <span class="d-none d-md-inline me-2">
                            <?php 
                            echo isset($_SESSION['user_name']) && !empty($_SESSION['user_name']) ? 
                                htmlspecialchars($_SESSION['user_name']) : 'المستخدم'; 
                            ?>
                        </span>
