            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th>الإقساط المدفوعة</th>
                        <th>إجمالي المدفوع</th>
                        <th>الإجراءات</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $contract_number = 1; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="../payments/view_installments.php?contract_id=<?php echo $contract['contract_id']; ?>" class="btn btn-sm btn-primary">عرض العقد</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
